    ...
    expected_table2_normalized = {
        0: {
          ...
          3: {
              ...
              'Filter until': Timestamp('2025-07-08 23:59:59'),
              'Status': 'ok',
              'Time since previous collection': datetime.datetime(1899, 12, 29, 23, 59, 58),
          },
          4: {
              'CSV filename': 'main_host.csv',
              'Collection timestamp': Timestamp('2025-07-08 00:00:00'),
              ...
              'Filter until': Timestamp('2025-07-08 23:59:59'),
              'Status': 'ok',
              'Time since previous collection': datetime.datetime(1899, 12, 29, 23, 59, 59),
          },
          5: {
              'CSV filename': 'job_host_summary.csv',
          ...
          6: {
              ...
              'Filter until': Timestamp('2025-07-09 23:59:59'),
              'Status': 'ok',
              'Time since previous collection': datetime.datetime(1900, 1, 1, 0, 0, 1),
          },
          7: {
              'CSV filename': 'main_indirectmanagednodeaudit.csv',
              ...
              'Filter until': Timestamp('2025-07-09 23:59:59'),
              'Status': 'ok',
              'Time since previous collection': datetime.datetime(1900, 1, 1, 0, 0, 2),
          },
          8: {
              'CSV filename': 'job_host_summary.csv',
              'Collection timestamp': Timestamp('2025-07-09 00:00:00'),
          ...
          11: {
              ...
              'Filter until': Timestamp('2025-07-10 23:59:59'),
              'Status': 'ok',
              'Time since previous collection': datetime.datetime(1900, 1, 1, 1, 0, 42),
          },
          12: {
              'CSV filename': 'job_host_summary.csv',
              ...
              'Filter until': Timestamp('2025-07-10 23:59:59'),
              'Status': 'ok',
              'Time since previous collection': datetime.datetime(1899, 12, 29, 22, 59, 18),
          },
          13: {
              'CSV filename': 'job_host_summary.csv',
              'Collection timestamp': Timestamp('2025-07-10 01:00:42'),
